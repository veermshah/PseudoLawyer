...
import SendVerificationCode from "../register/send-verification-code-form";
...
export default function ConfirmSignUpForm() {
    ...
    return (
        <div className="relative h-screen">
            ...
            />
            <div className="bg-white rounded-3xl w-1/2 h-3/5 bg-opacity-95 absolute z-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col justify-center items-center px-24">
                <motion.div
                ...
                <h2 className="text-5xl barlow-bold mb-12">Confirm Email</h2>
...
function ConfirmButton() {
    ...
    return (
        <motion.button
            ...
            className="bg-primary hover:bg-black text-white barlow-bold py-2 px-4 rounded-md w-full"
        >
            Register
        </motion.button>
    );
